...
public class GroupEditorActivity extends Activity implements Group.GroupChangeListener, OnItemClickListener
{
	...
	public void onItemClick(final AdapterView<?> adapterView, View view, int position, long id)
	{
		...
		final EditText groupLabel = dialogView.findViewById(R.id.text_group_label);
		groupLabel.setText(thisGroup.label());
		
		final CheckBox checkDelete = dialogView.findViewById(R.id.check_delete);
        final CheckBox checkHome = dialogView.findViewById(R.id.check_flag_home);
        final CheckBox checkApp = dialogView.findViewById(R.id.check_flag_app);
        final CheckBox checkGame = dialogView.findViewById(R.id.check_flag_game);
