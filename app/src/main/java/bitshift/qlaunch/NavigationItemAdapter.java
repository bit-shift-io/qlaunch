...
public class NavigationItemAdapter extends ArrayAdapter<NavigationItem>
{
    ...
    public View getView(int position, View view, ViewGroup parent)
    {
        ...
        {
            view = inflater.inflate(R.layout.navigation_heading, parent, false);

            TextView label = view.findViewById(R.id.tv_menu_label);
        ...
        {
            view = inflater.inflate(R.layout.navigation_blank, parent, false);
        }
        else
        {
