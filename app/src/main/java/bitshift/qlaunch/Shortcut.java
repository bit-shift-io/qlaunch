...
public class Shortcut extends GroupItem
{
    ...
    public boolean onItemLongClickInternal(AdapterView<?> adapterView, View view, int position, long id)
    {
        ...
        final EditText itemLabel = dialogView.findViewById(R.id.et_label);
        itemLabel.setText(label());

        final ImageView imgIcon = dialogView.findViewById(R.id.iv_icon);
        imgIcon.setImageDrawable(applicationIcon());
        ...
        final CheckBox cbRemove = dialogView.findViewById(R.id.cb_remove);
        final Shortcut item = this;

        // setup the spinner box
        final Spinner sGroup = dialogView.findViewById(R.id.s_group);
