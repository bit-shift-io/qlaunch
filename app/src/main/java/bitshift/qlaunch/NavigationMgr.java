...
public class NavigationMgr
{
    ...
    public void createMenuList()
    {
        ...
        addMenuItem(R.id.menu_add_shortcut, R.string.menu_add_shortcut, R.mipmap.ic_launcher);
        addMenuItem(R.id.menu_group_editor, R.string.menu_group_editor, R.mipmap.ic_launcher);
        addMenuItem(R.id.menu_select_wallpaper, R.string.menu_select_wallpaper, R.mipmap.ic_launcher);
        addMenuItem(R.id.menu_launcher_settings, R.string.menu_launcher_settings, R.mipmap.ic_launcher);
    }
