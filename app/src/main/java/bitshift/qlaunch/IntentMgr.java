...
public class IntentMgr extends BroadcastReceiver
{
    ...
    public static final String ACTION_VIEW_GROUP = "bitshift.qlaunch.action.VIEW_GROUP";
    public static final String ACTION_INSTALL_SHORTCUT = "com.android.launcher.action.INSTALL_SHORTCUT";
    public static final String ACTION_LOCK_DEVICE = "bitshift.qlaunch.action.LOCK_DEVICE";
...
*/
	...
	public void onReceive(Context context, Intent intent) 
	{
        ...
        Log.i(Globals.APP_NAME, intentAction);
